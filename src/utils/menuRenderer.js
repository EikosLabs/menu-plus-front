  ...
  html += `
    <footer class="menu-footer">
      <div class="footer-content">
        ...
        <div style="margin-top: 4rem; padding-top: 2rem; border-top: 1px solid rgba(0,0,0,0.05); text-align: center; opacity: 0.6;">
            <p style="font-size: 0.75rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.1em; color: #7c7c7c; margin-bottom: 0.5rem;">Powered by</p>
            <a href="https://eikoslabs.com" target="_blank" rel="noopener noreferrer" style="font-weight: 800; color: #4a4a4a; text-decoration: none; font-size: 0.9rem;">
                MenuPlus
            </a>
        </div>
      </div>

export function renderBusinessInfo(business) {
  ...
  // Contact Information
  if (business.address || business.phoneNumber || business.email) {
    html += `
      <div class="info-card">
  ...
  // Social Media
  if (business.facebookUrl || business.instagramUrl || business.twitterUrl || business.whatsAppNumber) {
    html += `
      <div class="info-card">
        <h3 class="info-card-title">
          <span class="info-icon">🌐</span>
    ...
    if (business.facebookUrl) {
      html += `
        <a href="${business.facebookUrl}" target="_blank" rel="noopener noreferrer" class="social-link social-link--facebook">
    ...
    if (business.instagramUrl) {
      html += `
        <a href="${business.instagramUrl}" target="_blank" rel="noopener noreferrer" class="social-link social-link--instagram">
          <svg viewBox="0 0 24 24" class="social-icon">
    ...
    if (business.twitterUrl) {
      html += `
        <a href="${business.twitterUrl}" target="_blank" rel="noopener noreferrer" class="social-link social-link--twitter">
          <svg viewBox="0 0 24 24" class="social-icon">
    ...
    if (business.whatsAppNumber) {
      const cleanNumber = business.whatsAppNumber.replace(/[^0-9]/g, '');
      html += `
        <a href="https://wa.me/${cleanNumber}" target="_blank" rel="noopener noreferrer" class="social-link social-link--whatsapp">
          <svg viewBox="0 0 24 24" class="social-icon">

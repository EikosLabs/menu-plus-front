...
export const ERROR_MESSAGES = {
  [ERROR_TYPES.INVALID_CREDENTIALS]: 'Email o contraseña incorrectos. Por favor verifica tus datos.',
  [ERROR_TYPES.UNAUTHORIZED]: 'No tienes permiso para realizar esta acción.',
  [ERROR_TYPES.TOKEN_EXPIRED]: 'Tu sesión ha expirado. Por favor inicia sesión nuevamente.',
  [ERROR_TYPES.SESSION_EXPIRED]: 'Tu sesión ha expirado. Por favor inicia sesión nuevamente.',
  [ERROR_TYPES.ACCOUNT_LOCKED]: 'Tu cuenta ha sido bloqueada. Contacta a soporte.',

  [ERROR_TYPES.VALIDATION_ERROR]: 'Por favor corrige los errores en el formulario.',
  ...
  [ERROR_TYPES.PASSWORD_TOO_WEAK]: 'La contraseña debe tener al menos 8 caracteres.',
  [ERROR_TYPES.DUPLICATE_EMAIL]: 'Este email ya está registrado. ¿Olvidaste tu contraseña?',
  [ERROR_TYPES.INVALID_FORMAT]: 'El formato de este campo no es válido.',

  [ERROR_TYPES.NETWORK_ERROR]: 'Error de conexión. Verifica tu internet e intenta nuevamente.',
  [ERROR_TYPES.TIMEOUT_ERROR]: 'La solicitud tardó demasiado. Por favor intenta nuevamente.',
  [ERROR_TYPES.CONNECTION_REFUSED]: 'No se pudo conectar al servidor. Intenta más tarde.',
  [ERROR_TYPES.NO_INTERNET]: 'No hay conexión a internet. Verifica tu red.',

  [ERROR_TYPES.SERVER_ERROR]: 'Error en el servidor. Estamos trabajando para solucionarlo.',
  ...
  [ERROR_TYPES.RATE_LIMITED]: 'Demasiadas solicitudes. Por favor espera un momento.',
  ...
  [ERROR_TYPES.INVALID_FILE_TYPE]: 'Tipo de archivo no válido. Solo se permiten imágenes.',
  [ERROR_TYPES.UPLOAD_FAILED]: 'Error al subir el archivo. Intenta nuevamente.',

  [ERROR_TYPES.UNKNOWN_ERROR]: 'Ocurrió un error inesperado. Por favor intenta nuevamente.',

...
export default function LoginForm() {
  ...
  const getFieldError = (field) => {
    ...
    switch (field) {
      ...
      case 'password':
        return validateRequired(password, t('auth.password'));
      default:
        return null;
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    const passwordError = validateRequired(password, t('auth.password'));
  ...
  return (
    <form className="neo-space-md" onSubmit={handleSubmit} data-testid="login-form">
      ...
      <FormField
        ...
        error={getFieldError('email') || fieldErrors?.email || (error?.type === ERROR_TYPES.UNAUTHORIZED ? t('auth.invalidCredentials') : null)}
      ...
      <PasswordInput
        ...
        error={getFieldError('password') || fieldErrors?.password || (error?.type === ERROR_TYPES.UNAUTHORIZED ? t('auth.invalidCredentials') : null)}
      />

      {/* Forgot Password Link */}
      <div className="text-right">
        <a href="/forgot-password" className="neo-text text-neo-flame hover:underline neo-text-bold text-sm">
      ...
      <div className="mt-4">
        <GoogleLoginButton
          ...
          onLoginError={(error) => {
            ...
            handleError({
              message: t('auth.googleLoginError'),
